...
def transaction_chart_data(transaction_id):
    ...
    transactions = rule.transactions(get_first_day_of_month(substract_months(transaction_date, months)), get_last_day_of_month(add_months(transaction_date, months)))
